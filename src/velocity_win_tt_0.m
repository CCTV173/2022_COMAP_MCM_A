function [p_acc0,t_acc0,vtq0,t_total0]=velocity_win_tt_0(p0,k0,t0,CP,W,N,v_in,L,cos,v_w)
t_total=1000000;
c1=0.140; %c 1
c2=3.750; %c 2
c3=83.9; %c 3
...
vtq0(1)=v_in;
    for i=1:(floor(t_acc/dt))
        vtq0(i+1)=(-(c2/c3)+p_acc*75/(c3*vtq0(i))-(c1*(vtq0(i)+v_w)^2)/c3)*dt+vtq0(i);
    end
